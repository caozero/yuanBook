# Raspberry Pi 32-bit Linux cross-compilation toolchain for YuanBook.
#
# Required compiler prefix defaults to arm-linux-gnueabihf. Override with either:
...
if(NOT DEFINED RPI_TOOLCHAIN_PREFIX OR RPI_TOOLCHAIN_PREFIX STREQUAL "")
    if(DEFINED ENV{RPI_TOOLCHAIN_PREFIX} AND NOT "$ENV{RPI_TOOLCHAIN_PREFIX}" STREQUAL "")
        ...
        set(RPI_TOOLCHAIN_PREFIX "arm-linux-gnueabihf" CACHE STRING "GNU cross compiler target prefix" FORCE)
    endif()
endif()
...
if(NOT _RPI_C_COMPILER OR NOT _RPI_CXX_COMPILER)
    message(FATAL_ERROR
        "Raspberry Pi armhf cross compiler was not found. "
